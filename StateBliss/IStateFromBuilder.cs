...
namespace StateBliss
{
    public interface IStateFromBuilder<TState> where TState : Enum
    {
        ...
        void OnEntering<TContext>(TState state, IGuardsInfo<TContext> guards) where TContext : GuardContext<TState>;
        ...
        void OnExiting<TContext>(TState state, IGuardsInfo<TContext> guards) where TContext : GuardContext<TState>;
        ...
        void OnEditing<TContext>(TState state, IGuardsInfo<TContext> guards) where TContext : GuardContext<TState>;
