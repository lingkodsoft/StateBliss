...
namespace StateBliss
{
    public interface IStateTransitionBuilder<TState> where TState : Enum
    {
        ...
        IStateTransitionBuilder<TState> Changed<TContext>(IHandlersInfo<TContext> handlers) where TContext : StateContext, new();
        ...
        IStateTransitionBuilder<TState> Changing<TContext>(IHandlersInfo<TContext> handlers) where TContext : HandlerStateContext<TState>, new();
