...
namespace StateBliss
{
    public interface IStateFromBuilder<TState> where TState : Enum
    {
        ...
        void OnEntering<TContext>(TState state, IHandlersInfo<TContext> handlers) where TContext : GuardStateContext<TState>, new();
        ...
        void OnExiting<TContext>(TState state, IHandlersInfo<TContext> handlers) where TContext : GuardStateContext<TState>, new();
        ...
        void OnEditing<TContext>(TState state, IHandlersInfo<TContext> handlers) where TContext : GuardStateContext<TState>, new();
